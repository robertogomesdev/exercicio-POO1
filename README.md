# Primeiro exercício de programação orientada a objetos! :tada:
# :page_with_curl: Sobre
Aplicação simples feita para aplicar conceitos iniciais da programação orientada a objetos como: entidades e métodos. 
